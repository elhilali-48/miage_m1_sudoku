...
/**
 * Interface de grille de sudoku. Chaque case d'une Grille peut contenir
 * un ElementDeGrille ou null si aucun élément n'est placé.
...
public interface Grille {
     ...
     * autorisé à cette position dans la grille
     * aux vues des autres valeurs de la grille
     * @throws CaractereInterditException si l'élément de grille n'est pas
     ...
     * @return true si value peut être placé dans la grille en position
     * x,y en respectant les règles du sudoku et sans modifier
     * une valeur initiale.
     * @throws HorsBornesException      si x ou y sont hors bornes
     * @throws CaractereInterditException si value n'est pas un carctère
