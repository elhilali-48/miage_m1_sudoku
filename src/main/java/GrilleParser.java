 ...
 * La première ligne doit contenir : le symbole de case vide.
...
public final class GrilleParser {
     ...
     * @throws IOException               format de grille en caractere incorrect
     * @throws ValeurImpossibleException si la grille ne respècte pas les règles
     * @throws ElementInterditException  exception 3
     * @throws HorsBornesException       exception 4
     * @throws ValeurInitialeModificationException exception 5
     * @return grille
     */
     public static Grille parse(final InputStream in)
        ...
        new BufferedReader(new InputStreamReader(in, StandardCharsets.UTF_8))) {
            ...
            for (int i = 1; i < line.length(); i++) {
                ...
                elementDeGrilleMap.
                put(value, new ElementDeGrilleImplAsChar(value));
            }
                ...
                for (int j = 0; j < dimension; j++) {
                    ...
                    if (c != vide) {
                        ...
                        if (elementDeGrille == null) {
                            throw new
                            ValeurImpossibleException(String.valueOf(c));
                        }
